...
JingleSession.prototype.sendOffer = function () {
    ...
    console.log("sendoffer done");
};

JingleSession.prototype.createdOffer = function (sdp) {
    console.log("inside createdoffer");
    var self = this;
	...
	try {
		...
		console.log("succesfully sent iq offer and got response;");
            ...
            function (stanza) {
		console.log("error while sending offer iq="+JSON.stringify(stanza));
                self.state = 'error';
                self.peerconnection.close();
                var error = ($(stanza).find('error').length) ? {
                    code: $(stanza).find('error').attr('code'),
...
JingleSession.prototype.setRemoteDescription = function (elem, desctype) {
    ...
    if (this.peerconnection.remoteDescription !== null && (this.peerconnection.remoteDescription.sdp != '' && this.peerconnection.remoteDescription.type != '')) {
...
JingleSession.prototype.muteAudio = function (muted) {
    this.connection.jingle.localStream.getAudioTracks().forEach(function (track) {
        track.enabled = !muted;
    });
};

JingleSession.prototype.muteVideo = function (muted) {
    this.connection.jingle.localStream.getVideoTracks().forEach(function (track) {
        track.enabled = !muted;
    });
};
